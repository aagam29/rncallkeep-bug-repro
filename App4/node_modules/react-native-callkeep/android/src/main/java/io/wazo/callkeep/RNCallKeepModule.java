...
public class RNCallKeepModule extends ReactContextBaseJavaModule {
    ...
    public void setup(ReadableMap options) {
        ...
        if (isConnectionServiceAvailable()) {
            Log.d(TAG, "zz isConnectionServiceAvailable 1"+isConnectionServiceAvailable());
    ...
    public void registerPhoneAccount() {
        ...
        Log.d(TAG, "zz registerPhoneAccount 2"+isConnectionServiceAvailable());
    ...
    private void registerPhoneAccount(Context appContext) {
        Log.d(TAG, "zz registerPhoneAccount3");
        if (!isConnectionServiceAvailable()) {
            return;
        }
        ...
        Log.d(TAG, "zz registerPhoneAccount4");
        telecomManager.registerPhoneAccount(account);
        Log.d(TAG, "zz registerPhoneAccount5");
    }
    ...
    private static boolean hasPhoneAccount() {
        Log.d(TAG, "zz isConnectionServiceAvailable()"+isConnectionServiceAvailable());
        Log.d(TAG, "zz telecomManager"+telecomManager );
        Log.d(TAG, "zz handle"+handle );
        Log.d(TAG, "zz telecomManager.getPhoneAccount(handle)"+telecomManager.getPhoneAccount(handle) );
        Log.d(TAG, "zz telecomManager.getPhoneAccount(handle).isEnabled()"+ telecomManager.getPhoneAccount(handle).isEnabled());
